...
/**
 * This is a model class for GeneratedObject5 type.
 */
public class GeneratedObject5 {
    private String name;
    private String date;
    ...
    /**
     * Converts this GeneratedObject5 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "GeneratedObject5 [" + "name=" + name + ", date=" + date + ", totalShares="
                + totalShares + ", totalAssets=" + totalAssets + ", currentShares=" + currentShares
                + ", change=" + change + ", changeP=" + changeP + "]";
    }

    /**
     * Builds a new {@link GeneratedObject5.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link GeneratedObject5.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link GeneratedObject5}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link GeneratedObject5} object using the set fields.
         * @return {@link GeneratedObject5}
         */
        public GeneratedObject5 build() {
            return new GeneratedObject5(name, date, totalShares, totalAssets, currentShares, change,
                    changeP);
        }
    }
}

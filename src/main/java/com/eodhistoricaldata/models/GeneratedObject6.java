...
/**
 * This is a model class for GeneratedObject6 type.
 */
public class GeneratedObject6 {
    private String name;
    private String date;
    ...
    /**
     * Converts this GeneratedObject6 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "GeneratedObject6 [" + "name=" + name + ", date=" + date + ", totalShares="
                + totalShares + ", totalAssets=" + totalAssets + ", currentShares=" + currentShares
                + ", change=" + change + ", changeP=" + changeP + "]";
    }

    /**
     * Builds a new {@link GeneratedObject6.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link GeneratedObject6.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link GeneratedObject6}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link GeneratedObject6} object using the set fields.
         * @return {@link GeneratedObject6}
         */
        public GeneratedObject6 build() {
            return new GeneratedObject6(name, date, totalShares, totalAssets, currentShares, change,
                    changeP);
        }
    }
}
